...
#Connect to MongoDB
	...
	companies = dbh.Data.find()
	#Imprime todas as empresas
	for company in companies:
		print (company)
	# Contar quantas empresas existem cadastradas
	countCompanies = dbh.Data.find().count()
	print "There are %d documents in Data collection" % countCompanies

	searchComp = raw_input("Empresa: ")
	company = dbh.Data.find_one({"name": searchComp})
	print (company)
